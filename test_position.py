...
class Test_position:
    ...
    def test_clear_button_position(self):
        root_9 = tk.Tk()
        app_9 = RetinalVesselSegmentationApp(root_9)
        
        #检测清除按钮的位置
        clear_button_position = app_9.clear_button.place_info()
        assert clear_button_position['x'] == '950'
        assert clear_button_position['y'] == '480'
