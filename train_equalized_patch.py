...
#保存网络参数
save_path = './UNet_equalized_patch.pth'    #网络参数的保存路径
...
print("训练完毕，训练时间为{:.2f}秒".format(end - start))